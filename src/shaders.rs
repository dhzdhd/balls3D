pub const VERTEX_SHADER: &'static str = "#version 400
...
// Projection * ModelView void main()
{
    ...
    // Convert position to clip coordinates and pass along gl_Position = MVP * vec4(VertexPosition,1.0);
}";

pub const FRAGMENT_SHADER: &'static str = "#version 400
